 ...
 */
export const createSFlowAgent = (model) => ({
    id: 'sflow',
    name: 'sFlow',
    model,
    instructions: `<Role>
...
createSFlowAgent.mode = MODE; // Kept for backward compat; agent-builder uses AGENT_MODES registry
//# sourceMappingURL=spec-flow.js.map