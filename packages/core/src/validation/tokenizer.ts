...
const CHINESE_STOP_WORDS = new Set([
  ...
  '你', '会', '着', '没有', '看', '好', '自己', '这', '那', '哪',
  '还', '能', '对', '可', '把', '被', '让', '从', '向', '以',
  '与', '为', '而', '但', '所', '如', '因', '将', '比', '或',
  '啊', '吧', '呢', '吗', '哦', '哈', '呀', '么', '嘛', '嗯',
  '已经', '可以', '应该', '能够', '必须', '需要', '这个', '那个',
  '什么', '怎么', '如何', '为什么', '时候', '之后', '之前', '目前',
  '现在', '将来', '然后', '所以', '但是', '而且', '虽然', '因为',
  '如果', '可以', '这样', '那样', '通过', '进行', '使用', '采用',
  '基于', '关于', '对于', '按照', '根据', '除了', '包括', '以及',
  '其中', '之后', '之间', '以上', '以下', '左右', '前后', '大小',
  // Spec-superflow specific
  '系统', '模块', '功能', '需求', '场景', '测试', '接口', '数据',
  '服务', '配置', '实现', '定义', '描述', '返回', '处理', '获取',
  '设置', '更新', '创建', '删除', '插入', '查询', '提交', '生成',
]);
