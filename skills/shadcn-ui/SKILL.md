...
See [references/ui-components.md](references/ui-components.md) for full component list and usage examples.
...
See [references/forms-and-validation.md](references/forms-and-validation.md) for advanced forms, contact forms, and login card patterns.
...
See [references/charts-components.md](references/charts-components.md) for Line, Area, Pie, and Radar chart examples.
