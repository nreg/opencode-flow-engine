...
Subagent:
  ...
  prompt: |
    ...
    Before writing any code, check `.flow-engine/sflow/lessons.md` for relevant lessons:
    ...
    3. Deduplicate: read the "已排除的方案" in `.flow-engine/sflow/progress.md` if it exists
...
- `[BRIEF_FILE]` — REQUIRED: the task brief file path
