...
export declare const SFLOW_AGENT_NAMES: readonly ["sFlow", "need-explorer", "spec-writer", "contract-builder", "build-executor", "bug-investigator", "code-reviewer", "release-archivist", "spec-merger", "ui-implementer"];
